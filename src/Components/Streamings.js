    ...
    return (
        <div className="streamings">
            ...
            <ul className={`streamings__list ${streamingsIsOpen ? '' : 'streamings__list_type_mobile'}`}>
                ...
                <li className="streamings__list-item">
                    <a className="streamings__link" rel="noreferrer" href="https://www.spotify.com/ru-ru/"
                       target="_blank">
                        Spotify &#8599;</a>
                </li>
                <li className="streamings__list-item">
                    <a className="streamings__link" rel="noreferrer" href="https://www.apple.com/ru/apple-music/"
                       target="_blank">
                        Apple Music &#8599;</a>
                </li>
                <li className="streamings__list-item">
